messages_ru = {
    ...
    "enterdeadline": "Введите дедлайн задачи в формате 12.07.2024 12:30. Часовой пояс <b>МСК</b>.",
    ...
    "stats": (
        "<b>Статистика</b>:\n"
        "За последнюю <b>неделю</b> завершено задач: %d (Из них завершено через /complete %d задач)\n"
        "За последний <b>месяц</b> завершено задач: %d (Из них завершено через /complete %d задач)\n"
    ),
}
